...
// import { StyleSheet, View, Text, ActivityIndicator, PermissionsAndroid, Platform, Alert, TouchableOpacity } from 'react-native';
...
//             message: 'This app needs to access your location to show hotspots near you.',
//             buttonPositive: 'OK',
//           },
//         );
...
//         const mockData = [
//             { "latitude": 19.42867, "longitude": 72.81963, "severity": 1, "radius": 100 },
//             { "latitude": 19.429, "longitude": 72.820, "severity": 3, "radius": 150 },
//             { "latitude": 19.427, "longitude": 72.818, "severity": 2, "radius": 100 },
//             { "latitude": 19.43, "longitude": 72.821, "severity": 5, "radius": 120 },
//         ];
...
//             const currentLocation = { latitude, longitude, latitudeDelta: 0.0922, longitudeDelta: 0.0421 };
//             setRegion(currentLocation);
//             setUserLocation(currentLocation);
//             setIsLoading(false);
//           },
//           (error) => {
//             Alert.alert("Location Error", "Could not fetch location. Using a default.");
...
//           let circleColor = 'rgba(255, 255, 0, 0.3)'; // Default: Yellow for low severity
//           if (spot.severity > 3) {
//             circleColor = 'rgba(255, 0, 0, 0.3)'; // Red for high severity
//           } else if (spot.severity === 3) {
//             circleColor = 'rgba(255, 165, 0, 0.3)'; // Orange for medium severity
//           }
...
//               radius={spot.radius || 50} // Use radius from data or default to 100m
//               fillColor={circleColor}
//               strokeWidth={1}
//               strokeColor={circleColor.replace('0.3', '0.5')} // Make border slightly more opaque
//             />
//           );
//         })}
//       </MapView>
