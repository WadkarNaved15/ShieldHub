...
//                 edgePadding: { top: 350, right: 50, bottom: 300, left: 50 },
//                 animated: true,
//               });
//             }
//           }, 500);
...
//           if (isSelected) {
//              strokeColor = route.risk_level === 'Safe' ? '#10B981' : '#EF4444';
//           }
...
//                 <Marker coordinate={selectedRoute.coordinates[selectedRoute.coordinates.length - 1]} title="Destination" />
//             </>
//         )}
//       </MapView>
...
//                 ) : (
//                     <Text style={styles.goButtonText}>Find Safe Routes</Text>
//                 )}
//             </TouchableOpacity>
//           </View>
//         </SafeAreaView>
...
//                 ROUTE {selectedRouteIndex + 1} OF {routes.length}
//               </Text>
//               <Text style={styles.routeSummary} numberOfLines={1}>{selectedRoute.summary}</Text>
//             </View>
//             <View style={[
//                 styles.safetyBadge, 
//                 { backgroundColor: selectedRoute.risk_level === 'Safe' ? '#ECFDF5' : '#FEF2F2' }
//             ]}>
//                 <Text style={[
//                     styles.safetyText,
//                     { color: selectedRoute.risk_level === 'Safe' ? '#059669' : '#DC2626' }
//                 ]}>
...
//                 <Text style={[
//                     styles.statValue, 
//                     { color: selectedRoute.risk_level === 'Safe' ? '#059669' : '#D97706' }
//                 ]}>
...
//                     routes.length > 1 ? { flex: 1, marginLeft: 10 } : { width: '100%' }
//                 ]}
...
//   searchCard: {
//     marginHorizontal: 16, marginTop: Platform.OS === 'android' ? 40 : 10,
...
//   goButton: { 
//     backgroundColor: '#111827', borderRadius: 14, height: 52,
...
//   altRouteButton: {
//     backgroundColor: '#F3F4F6', borderRadius: 14, height: 54, paddingHorizontal: 20,
//     justifyContent: 'center', alignItems: 'center', marginRight: 10,
//   },
//   altRouteText: { color: '#374151', fontSize: 14, fontWeight: '700' },
...
//   },
//   navButtonText: { color: 'white', fontSize: 17, fontWeight: '700' }
// });
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {selectedRoute && (
            <>
                {/* Custom Start Marker (Green Dot with White Border) */}
                <Marker coordinate={selectedRoute.coordinates[0]} title="Start">
          ...
          <View style={styles.actionButtonsRow}>
            ...
            {routes.length > 1 && (
                <TouchableOpacity 
                    ...
                    onPress={selectNextRoute}
                >
                    <Text style={styles.altRouteText}>Alternate Route</Text>
                </TouchableOpacity>
            )}

            {/* Navigation Button (Fixed Text Size) */}
            <TouchableOpacity 
                style={[
                    styles.startNavButton, 
                    routes.length > 1 ? { flex: 1.5, marginLeft: 10 } : { width: '100%' }
                ]}
                onPress={startNavigation}
                activeOpacity={0.8}
            >
...
const styles = StyleSheet.create({
  ...
  altRouteButton: {
    backgroundColor: '#F3F4F6', borderRadius: 14, height: 50, paddingHorizontal: 16,
    justifyContent: 'center', alignItems: 'center', marginRight: 10,
  },
  altRouteText: { color: '#374151', fontSize: 13, fontWeight: '700' }, // Reduced size
  ...
  navButtonText: { color: 'white', fontSize: 15, fontWeight: '700' }, // Reduced size for better fit
